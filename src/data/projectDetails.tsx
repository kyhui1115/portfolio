        ...
        body: (
          <>
            <li className="mb-2">
              ...
              높을 것으로 예측되어 모바일 앱 제작의 필요성을 느꼈습니다.
            </li>
            <li className="mb-2">
              프론트엔드는 혼자 개발해야 했고, 두달 정도 기간 내에 개발해야 했기
              때문에 웹 개발(React) 경험을 활용할 수 있고 러닝커브가 낮은
              React와 React-native를 사용하여 웹뷰를 통해 모바일에 웹 화면을
              띄우는 방식으로 하이브리드 앱을 구현하였습니다.
            </li>
            <li className="">
              또한 PostMessage와 injectJavascript를 통해 웹뷰와 React-native
              간의 데이터 통신을 가능하게 하여 단순히 웹뷰를 넘어서 모바일
              앱으로서 기능을 할 수 있도록 하였습니다.
            </li>
          </>
        ),
      },
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              물리 버튼 클릭 시 앱이 종료되는 문제가 발생하였습니다.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              ...
              감지하여 PostMessage로 웹뷰에 신호를 보내 뒤로가기의 기능을 할 수
              있도록 하였습니다.
            </li>
            <li className="">
        ...
        body: (
          <>
            ...
            <li className="mb-2">
              ...
              됐지만, 앱의 경우 모바일 기기의 위치 권한 및 정보를 웹뷰에
              전달하여 처리하는 과정이 필요했습니다.
            </li>
            <li className="mb-2">
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              요청하는 코드를 작성하였으나 같은 정보를 요청하는 코드가 여러
              페이지에 중복으로 작성되는 것을 파악하였습니다.
            </li>
            <li className="mb-2">
              서버에서 데이터 요청 시 필요한 정보나 endpoint 등이 변경될 경우
              각각의 페이지에서 변경해야 하므로 여러 번 작업해야 하고 이
              과정에서 실수가 발생할 수 있을 것이라고 예측하였습니다.
            </li>
            <li className="">
              서버 데이터 요청 중 자주 사용되는 코드를 custom hook으로
              모듈화하여 15 ~ 30줄 정도의 코드를 한 줄로 불러와 여러 페이지에서
              사용하여 유지보수성 및 재사용성을 높일 수 있었습니다.
            </li>
          </>
        ),
      },
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              조회하는 UI와 기능을 구현하였는데 주문 목록이 많을 경우 데이터가
              늦게 로딩되어 빈 화면이 보였습니다.
            </li>
            <li className="mb-2">
            ...
            <li className="">
              ...
              정보는 드랍다운 UI를 통해 클릭하여 확인할 수 있도록 하여 빠르게
              주문 목록을 확인할 수 있게 되었습니다.
            </li>
          </>
        ),
      },
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              구현하여 정보를 더 쾌적하게 확인할 수 있도록 하였는데, 재접속 및
              새로고침 시 메뉴의 상태가 유지되지 않아 매번 다시 설정해야
              했습니다.
            </li>
            <li className="">
              이를 해결하기 위해 브라우저 저장소인 localStorage에 메뉴의 상태를
              저장하여 사용자가 지정한 메뉴의 상태가 계속해서 유지될 수 있도록
              하였습니다.
            </li>
          </>
        ),
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              데이터를 입력하고 validation 기능도 추가하다 보니 코드가
              복잡해지는 것을 파악하였습니다.
            </li>
            <li className="mb-2">
        ...
        body: (
          <>
            <li className="mb-2">
              ...
              많아 API 작업이 완료되지 않거나 서버에 오류가 발생했을 때 확인 및
              테스트의 어려움을 겪었습니다. 또한 서버와 클라이언트를 연결하기
              위한 추가 작업을 하다보니 일정이 계속해서 지연되었습니다.
            </li>
            <li className="mb-2">
              최대한 서로 간의 일정을 맞추려 노력하여 작업 시간대를 맞출 수
              있었지만 언제든지 작업 시간대가 달라질 수 있고, 서버에 오류가
              발생했을 때 작업이 지연되는 문제를 해결할 필요가 있었습니다.
            </li>
            <li className="">
